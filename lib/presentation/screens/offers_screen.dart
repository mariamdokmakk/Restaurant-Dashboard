...
import 'package:rest_dashboard/data/services/offer_services.dart';
...
class _OffersScreenState extends State<OffersScreen> {
  ...
  void _createOffer() async {
    if (_formKey.currentState!.validate()) {
      ...
      await OffersServices.createOfferForCategory(
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          StreamBuilder(
            stream: OffersServices.getAllOffers(),
            builder: (context, snapshot) {
              ...
              return SingleChildScrollView(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    AllOffersSection(offers: data, onDeleteOffer: _deleteOffer),
                  ],
                ),
              );
            },
